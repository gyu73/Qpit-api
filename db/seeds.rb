...
Hint.create(has_like_person: 'いる', belong_to_club: '入っている', club: 'テニス部', hair_style: 'ショートカット', clothing: 'カジュアル', height: '156cm', personality: '優しい', age: '19', school: '山本高校', company: 'セブンイレブン', favorite_phrase: '笑顔が素敵なところ', like_food: 'コロッケ', like_music: 'greeeen', hobby: 'ランニング', like_subject: '数学', hate_subject: '社会', has_spoken: 'ある', user_id: '1')
